...
namespace Pong
{
    ...
    public class Game1 : Game
    {
        ...
        protected override void Initialize()
        {
            ...
            PaddleBottom.X = 160;//<PaddleBottom X Position>;
            PaddleBottom.Y = 840;// <PaddleBottom Y Position>;
            PaddleTop = new Paddle(GameConstants.PaddleDefaultWidth, GameConstants.PaddleDefaulHeight, GameConstants.PaddleDefaulSpeed);
            PaddleTop.X = 160;//< PaddleTop X Position >;
            ...
            Ball = new Ball(GameConstants.DefaultBallSize, GameConstants.DefaultInitialBallSpeed, GameConstants.DefaultBallBumpSpeedIncreaseFactor)
            {
                ...
                Y = 400 //< Ball center Y Position >
            };
            Background = new Background(500, 900/*< width of the screen bounds >, < height of the screen bounds >*/);
